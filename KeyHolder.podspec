Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/octopusthink/KeyHolder"
  s.author       = { "Econa77" => "f.s.1992.ip@gmail.com" }
  s.source       = { :git => "https://github.com/octopusthink/KeyHolder.git", :tag => "v#{s.version}" }
  s.platform     = :osx, '10.9'
  s.source_files = 'Lib/KeyHolder/*.swift'
  s.resource_bundles = { 'KeyHolder' => ['Lib/KeyHolder/Resources/*.png'] }
  s.frameworks   = 'Carbon', 'Cocoa'
  s.dependency 'Magnet', :git => 'https://github.com/octopusthink/Magnet.git'
end
